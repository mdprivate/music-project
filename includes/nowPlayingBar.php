...
<script>
    ...
    function setMute() {
        ...
        var imageName;
        if (imageName = audioElement.audio.muted) {
    ...
    function setTrack(trackId, newPlaylist, play) {
        ...
        $.post("includes/config/ajax/getSongJson.php", {
            songId: trackId
        }, function(data) {
            var track = JSON.parse(data);
		    $(".trackName span").text(track.title);

            $.post("includes/config/ajax/getArtistJson.php", {
    ...
    function playSong() {
        ...
        if (audioElement.audio.currentTime === 0) {
            $.post("includes/config/ajax/updatePlays.php", {
